...
test("native package build numbers stay aligned", async () => {
  ...
  assert.match(
    windows,
    new RegExp(`<AssemblyVersion>1\\.5\\.15\\.${buildNumber}</AssemblyVersion>`),
  );
  assert.match(
    windows,
    new RegExp(`<FileVersion>1\\.5\\.15\\.${buildNumber}</FileVersion>`),
  );
