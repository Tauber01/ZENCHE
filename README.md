...
- 1.5.10 / build 37 の完全パッケージと SHA-256 マニフェストは公式更新フィード向けに準備済みで、本番切り替えと公開回帰確認後に有効になります。クライアントは自身を無断で上書きせず、各 OS のインストール手順へ渡します。
...
1.5.9 / build 36 アセットは利用可能です。1.5.10 / build 37 の自社ホストマニフェストと
パッケージは、本番切り替えとプラットフォーム別の公開回帰確認を待つ候補です。
