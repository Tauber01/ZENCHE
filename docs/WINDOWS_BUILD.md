...
```text
dist/ZENCHE-1.1.0-Windows-x64-Setup.exe
dist/ZENCHE-1.1.0-Windows-x64-Setup.exe.sha256
dist/ZENCHE-1.1.0-Windows-x64.zip
dist/ZENCHE-1.1.0-Windows-x64.zip.sha256
```
