...
- 当前源码版本：1.5.11
- 当前原生构建号：38
- 发布状态：1.5.11 / build 38 已作为 [GitHub 公开稳定版](https://github.com/Tauber01/ZENCHE/releases/tag/v1.5.11) 发布；官网自动更新未切换，继续提供 W14 的 1.5.10 / build 37
