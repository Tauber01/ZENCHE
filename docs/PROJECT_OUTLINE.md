...
- 当前源码版本：1.5.12
- 当前原生构建号：39
- 发布状态：Tauber 已授权把 1.5.12 / build 39 作为下一版 GitHub 公开稳定版发布；六个安装包、六份侧车及 14 项聚合包已从冻结候选重建并完成本地校验，正在等待最终内容审查、标签与 Release。发布完成前，GitHub 当前稳定版仍为 [v1.5.11](https://github.com/Tauber01/ZENCHE/releases/tag/v1.5.11)。官网自动更新不在本次授权范围内，继续提供 W14 的 1.5.10 / build 37
