...
- 当前源码版本：1.5.13
- 当前原生构建号：40
- 发布状态：1.5.13 / build 40 已完成 GitHub 发布前冻结；目标为 [GitHub Release v1.5.13](https://github.com/Tauber01/ZENCHE/releases/tag/v1.5.13)。六个五端安装包及六份 SHA-256 侧车已从最终实现提交 `a89e2f89416e6a70564258d9f421d58d6cdc75cd` 重建并回验；聚合交付包为 275,166,398 字节，SHA-256 `e6304e72477e9f8c64cff7b1d68ec36750eb928fb8b02faf33bfa3f576c10266`。当前仍待推送、打标签、创建 Release 与在线核对；官网自动更新不在本次范围内，继续提供 W14 的 1.5.10 / build 37。
