...
- 当前源码版本：1.5.12
- 当前原生构建号：39
- 发布状态：1.5.12 / build 39 已于 2026-08-11T09:10:29Z 发布为 [GitHub Latest](https://github.com/Tauber01/ZENCHE/releases/tag/v1.5.12)。注释标签 `v1.5.12` 解引用到 `bb9aab0707a0260e6dd44667836e710d2820485f`；Release ID `368441961`，非草稿、非预发布，14 个线上附件的名称、字节数与 GitHub SHA-256 摘要已和本地冻结资产逐项比对，14/14 一致。官网自动更新不在本次授权范围内，继续提供 W14 的 1.5.10 / build 37
